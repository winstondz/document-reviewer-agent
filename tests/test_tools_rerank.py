"""Tests for the rerank (broad vector retrieval + cross-encoder) strategy.

Note: the cross-encoder model downloads on first run (~small, <100MB).
"""
...
def chain():
    ...
    return build_rag_chain(strategy="rerank")
